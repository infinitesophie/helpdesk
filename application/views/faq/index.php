...
<span class="glyphicon glyphicon-search" aria-hidden="true"></span></button>
        <ul class="dropdown-menu small-text" style="min-width: 90px !important; left: -90px;">
          ...
          <li><a href="#" onclick="change_search(2)"><span class="glyphicon glyphicon-ok no-display" id="title-exact"></span> <?php echo lang("ctn_464") ?></a></li>
        </ul>
      </div><!-- /btn-group -->
</div>
</div>

     <input type="button" class="btn btn-primary btn-sm" value="<?php echo lang("ctn_785") ?>" data-toggle="modal" data-target="#myModal" />
</div>
</div>
...
<thead>
<tr class="table-header"><td><?php echo lang("ctn_783") ?></td><td><?php echo lang("ctn_462") ?></td><td><?php echo lang("ctn_52") ?></td></tr>
</thead>
<tbody>
</tbody>
</table>
  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="myModalLabel"><span class="glyphicon glyphicon-send"></span> <?php echo lang("ctn_785") ?></h4>
      </div>
      <div class="modal-body">
         <?php echo form_open(site_url("FAQ/add_pro"), array("class" => "form-horizontal")) ?>
            ...
            <div class="form-group">
                    ...
                    <div class="col-md-8">
                        <textarea name="answer" id="cat-description"></textarea>
                    </div>
            </div>
            <div class="form-group">
   ...
   var st = $('#search_type').val();
    var table = $('#cat-table').DataTable({
      ...
      "processing": false,
        ...
        "ajax": {
            url : "<?php echo site_url("FAQ/faq_page") ?>",
            type : 'GET',
            data : function ( d ) {
