...
<span class="glyphicon glyphicon-search" aria-hidden="true"></span></button>
    ...
    <input type="button" class="btn btn-primary btn-sm" value="<?php echo lang("ctn_837") ?>" data-toggle="modal" data-target="#myModal" />
</div>
</div>
...
<thead>
<tr class="table-header"><td><?php echo lang("ctn_508") ?></td><td><?php echo lang("ctn_831") ?></td><td><?php echo lang("ctn_52") ?></td></tr>
</thead>
<tbody>
</tbody>
</table>
  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="myModalLabel"><span class="glyphicon glyphicon-send"></span> <?php echo lang("ctn_837") ?></h4>
      </div>
      <div class="modal-body">
         <?php echo form_open_multipart(site_url("documentation/add_project"), array("class" => "form-horizontal")) ?>
