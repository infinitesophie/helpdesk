    ...
    <div class="container-fluid">
      <div class="row">
        <div class="col-sm-3 col-md-2 sidebar">
         ...
         <div class="user-sidebar-area">
          ...
          <div class="media-body">
            <p class="no-p-margin"><?php echo lang("ctn_669") ?> <?php echo $this->user->info->first_name ?></p>
        ...
        <div class="user-sidebar-icons">
          <a href="<?php echo site_url("user_settings") ?>" data-toggle="tooltip" data-placement="top" title="<?php echo lang("ctn_156") ?>"><span class="glyphicon glyphicon-cog"></span></a> <a href="<?php echo site_url("home/notifications") ?>" data-toggle="tooltip" data-placement="top" title="<?php echo lang("ctn_498") ?>"><span class="glyphicon glyphicon-bell"></span></a> <a href="<?php echo site_url("profile/" . $this->user->info->username) ?>" data-toggle="tooltip" data-placement="top" title="<?php echo lang("ctn_200") ?>"><span class="glyphicon glyphicon-user"></span></a>
          </div>
        <?php endif; ?>
