...
<span class="glyphicon glyphicon-search" aria-hidden="true"></span></button>
        <ul class="dropdown-menu small-text" style="min-width: 90px !important; left: -90px;">
          ...
          <li><a href="#" onclick="change_search(2)"><span class="glyphicon glyphicon-ok no-display" id="title-exact"></span> <?php echo lang("ctn_389") ?></a></li>
        </ul>
      </div><!-- /btn-group -->
</div>
</div>
...
<table id="canned-table" class="table table-bordered table-hover table-striped">
<thead>
...
$(document).ready(function() {
   ...
   var st = $('#search_type').val();
    var table = $('#canned-table').DataTable({
      ...
      "processing": false,
        ...
        "ajax": {
            url : "<?php echo site_url("tickets/canned_page") ?>",
            type : 'GET',
            data : function ( d ) {
