...
<span class="glyphicon glyphicon-search" aria-hidden="true"></span></button>
    ...
    <a href="<?php echo site_url("tickets/add_custom_field") ?>" class="btn btn-primary btn-sm"><?php echo lang("ctn_373") ?></a>
</div>
</div>
...
<thead>
<tr class="table-header"><td><?php echo lang("ctn_574") ?></td><td><?php echo lang("ctn_575") ?></td><td><?php echo lang("ctn_52") ?></td></tr>
</thead>
<tbody>
   ...
   var st = $('#search_type').val();
    var table = $('#custom-table').DataTable({
      ...
      "processing": false,
        ...
        "ajax": {
            url : "<?php echo site_url("tickets/field_page") ?>",
            type : 'GET',
            data : function ( d ) {
