...
<?php echo form_open(site_url("tickets/add_canned_response_pro"), array("class" => "form-horizontal")) ?>
...
<div class="form-group">
        ...
        <div class="col-md-8 ui-front">
            <textarea name="body" id="canned-area"></textarea>
        </div>
</div>
<input type="submit" name="s" class="btn btn-primary btn-xs form-control" value="<?php echo lang("ctn_568") ?>">
<?php echo form_close() ?>
</div>
</div>
