...
<thead>
<tr class="table-header"><td><?php echo lang("ctn_11") ?></td><td><?php echo lang("ctn_706") ?></td><td><?php echo lang("ctn_148") ?></td><td><?php echo lang("ctn_52") ?></td></tr>
</thead>
<tbody>
</tbody>
</table>
  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="myModalLabel"><span class="glyphicon glyphicon-send"></span> <?php echo lang("ctn_716") ?></h4>
      </div>
          ...
          <div class="form-group">
            ...
            <div class="form-group">
                    ...
                    <div class="col-md-8">
                        ...
                        <option value="ticket_reply"><?php echo lang("ctn_708") ?></option>
                        <option value="ticket_creation"><?php echo lang("ctn_709") ?></option>
                        <option value="guest_ticket_creation"><?php echo lang("ctn_710") ?></option>
                        <option value="ticket_reminder"><?php echo lang("ctn_711") ?></option>
                        <option value="new_notification"><?php echo lang("ctn_764") ?></option>
                        <option value="close_ticket"><?php echo lang("ctn_795") ?></option>
                        </select>
      ...
      <div class="modal-footer">
        ...
        <input type="submit" class="btn btn-primary" value="<?php echo lang("ctn_716") ?>">
        <?php echo form_close() ?>
      </div>
    </div>
  </div>
