<div class="container">
  <div class="row">
    <div class="col-md-12 content-area">
         ...
         <h3 class="home-label"><?php echo lang("ctn_250") ?></h3> 
...
<?php if($stripe !==null)  : ?>
<hr>
<h3><?php echo lang("ctn_443") ?></h3>
<p><?php echo lang("ctn_444") ?></p>
...
<form action="<?php echo site_url("IPN/stripe/1") ?>" method="POST">
  <script
    ...
    data-amount="500"
    data-label="<?php echo lang("ctn_624") ?> <?php echo $this->settings->info->payment_symbol ?>5.00 <?php echo lang("ctn_350") ?>"
...
<form action="<?php echo site_url("IPN/stripe/2") ?>" method="POST">
  <script
    ...
    data-key="<?php echo $stripe['publishable_key']; ?>"
    data-amount="1000"
    data-label="<?php echo lang("ctn_624") ?> <?php echo $this->settings->info->payment_symbol ?>10.00 <?php echo lang("ctn_350") ?>"
...
<form action="<?php echo site_url("IPN/stripe/3") ?>" method="POST">
  <script
    ...
    data-key="<?php echo $stripe['publishable_key']; ?>"
    data-amount="3000"
    data-label="<?php echo lang("ctn_624") ?> <?php echo $this->settings->info->payment_symbol ?>30.00 <?php echo lang("ctn_350") ?>"
...
<div class="row">
    ...
    <div class="col-md-4">
        <form action='https://www.2checkout.com/checkout/purchase' method='post'>
                ...
                <input type="hidden" name="currency_code" value="<?php echo $this->settings->info->paypal_currency ?>" />
                <input name='submit' type='submit' value='<?php echo lang("ctn_624") ?> <?php echo $this->settings->info->payment_symbol ?>5.00 <?php echo lang("ctn_350") ?>' />
                </form>
    </div>
    <div class="col-md-4">
        <form action='https://www.2checkout.com/checkout/purchase' method='post'>
                ...
                <input type="hidden" name="currency_code" value="<?php echo $this->settings->info->paypal_currency ?>" />
                <input name='submit' type='submit' value='<?php echo lang("ctn_624") ?> <?php echo $this->settings->info->payment_symbol ?>10.00 <?php echo lang("ctn_350") ?>' />
                </form>
    </div>
    <div class="col-md-4">
        <form action='https://www.2checkout.com/checkout/purchase' method='post'>
                ...
                <input type="hidden" name="currency_code" value="<?php echo $this->settings->info->paypal_currency ?>" />
                <input name='submit' type='submit' value='<?php echo lang("ctn_624") ?> <?php echo $this->settings->info->payment_symbol ?>30.00 <?php echo lang("ctn_350") ?>' />
                </form>
    </div>
</div>
<?php endif; ?>
